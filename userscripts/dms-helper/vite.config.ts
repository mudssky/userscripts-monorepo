  ...
  plugins: [
    monkey({
      ...
      userscript: {
        ...
        match: ['*://dms.aliyun.com/*', '*://dmsnext.console.aliyun.com/_console/sql-console*'],
        ...
        downloadURL: 'https://github.com/mudssky/userscripts-monorepo/releases/latest/download/dms-helper.user.js',
      },
    }),
  ],
})
