...
declare const GM_registerMenuCommand:
  | ((name: string, callback: () => void) => number)
  | undefined
declare const GM_setClipboard:
  | ((text: string, info?: string) => void)
  | undefined
declare const GM_notification:
  | ((details: { text: string; title?: string; timeout?: number }) => void)
  | undefined
declare const GM_info:
  | { script: { version: string; name: string; namespace: string } }
  | undefined
